...
Accordion: Install the Github App
Accordion: Create a Github Source

Section: Use the Miru Web App

Accordion: Create a Device Group
Accordion: Creating a Device

Section: Install the Miru Agent

Accordion: Install Miru
Accordion: Install/Upgrade Docker
Accordion: Authenticate your Device

Section: Deploy an Update

Accordion: Prepare your Deployment
Accordion: Use Docker Compose
Accordion: Deploy your Application
...
<AccordionGroup>
  ...
  <Accordion icon = 'github' title = 'Create a Github Source'>
  ...
  with Docker Compose](https://www.notion.so/Miru-Docs-Getting-Started-f652cc005b884e9bad23d778196ffc0e?pvs=21)
  section (***PLEASE FIX needs Mintlify link***). For now, we'll focus on connecting our GitHub.
...
<AccordionGroup>
  ...
  <Accordion icon="layer-group" title="Create a Device Group">
  ...
  <Accordion icon="robot" title="Create a Device">
...
<AccordionGroup>
  ...
  <Accordion icon="instalod" title="Install Miru">
  ...
  <Accordion icon="docker" title="Install/Upgrade Docker">
  ...
  <Accordion icon="key" title="Authenticate your Device">
...
<AccordionGroup>
  ...
  <Accordion icon="check" title="Prepare your Deployment">
    ...
    We’ll walk through a deployment by just pushing a change to GitHub. A simple push will trigger a new deployment to your device with Miru. This is because we specified the device’s group to track the main branch and /todo/ build path of your miru-examples repository in the **Create a Device** section.
    {/* TODO: Figure out how to hyperlink these sections to other parts of the page once you've published*/}
...
├── ...
  ...
  Open the **/todo** directory in your favorite code editor to examine the code and containers that will be deployed onto your device. While there are other folders within the miru-examples repository, we setup the Device Group to only look at the **todo** folder by specifying the build path as /**todo** when creating the Device Group.
  {/*TODO: Hyperlink 'creating the Device Group'*/}
...
└── frontend/
  ...
  <Accordion icon="docker" title="Use Docker Compose">
...
└── frontend/
  ...
  <Accordion icon="play" title="Deploy your Application">
  ...
  <Accordion icon="magnifying-glass" title="Verify your Deployment">
